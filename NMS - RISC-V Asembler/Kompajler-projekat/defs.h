...
#define code(args...) ({fprintf(output, args); \
          if (++out_lin > 10000) err("Too many output lines"), exit(1); })
...
static char *ar_instructions[] = { "add", "sub", "mul", "div",
                                   "add", "sub", "mul", "divu" };
...
static char* jumps[]={"blt", "bgt", "ble", "bge", "beq ", "bne ",
					 "bltu", "bgtu", "bleu", "bgeu", "beq ", "bne " };

static char* opp_jumps[]={"bge", "ble", "bgt", "blt", "bne ", "beq ",
